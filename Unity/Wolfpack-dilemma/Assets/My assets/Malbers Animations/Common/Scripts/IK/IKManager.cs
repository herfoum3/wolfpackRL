...
namespace MalbersAnimations.IK
{
    ...
    public class IKManagerEditor : Editor
    {
        ...
        private static readonly string[] EditorLabel = new string[] { "IK Processors", "Weight Processors", "Events" };
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (Reo_Sets.count > 0 && index > -1 && index < Reo_Sets.count)
            {
                ...
                using (new GUILayout.VerticalScope(EditorStyles.helpBox))
                {
                    ...
                    EditorGUILayout.PropertyField(selectedSet, new GUIContent($"[[{selectedSet.displayName}] IK Set]"), false);
                    EditorGUI.indentLevel--;
            ...
            if (index != -1 && index < link.arraySize)
            {
                ...
                if (ikProcessor != null)
                {
                    ...
                    using (new GUILayout.VerticalScope(EditorStyles.helpBox))
                    {
                        ...
                        if (Tindex == -1) CurrentTarget = "  [No Target Needed]";
