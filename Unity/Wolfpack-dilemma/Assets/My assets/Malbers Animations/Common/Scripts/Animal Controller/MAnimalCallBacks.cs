...
namespace MalbersAnimations.Controller
{
    ...
    public partial class MAnimal
    {
            ...
            bool ResetGravity, bool ForceAirControl = true, float LimitForce = 0)
        {
            ...
            CurrentExternalForce = Vector3.Lerp(CurrentExternalForce, ExternalForce, Aceleration);

            //Debug.Log($"Force Added {ExternalForce}", this);
        }
        ...
        {
            if (CurrentExternalForce == Vector3.zero) return;
